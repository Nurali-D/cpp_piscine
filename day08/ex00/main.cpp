...
int main()
{
	...
	{
		std::cerr << "Cannot find 4" << std::endl;
	}
	try
	{
	...
	{
		std::cerr << "Cannot find 1" << std::endl;
	}
	try
	{
	...
	{
		std::cerr << "Cannot find 38" << std::endl;
	}
	...
	{
		std::cerr << "Cannot find 0" << std::endl;
	}
	try
	{
	...
	{
		std::cerr << "Cannot find -7" << std::endl;
	}
